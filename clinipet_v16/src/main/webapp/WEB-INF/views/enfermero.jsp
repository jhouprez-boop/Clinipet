...
<div class="layout">
    <aside class="side">
        ...
        <a href="${pageContext.request.contextPath}/perfil" class="user-card" style="text-decoration:none;color:inherit;display:flex;align-items:center;gap:10px">
            ...
            <% } %>
            <span><strong><%= usuario != null ? usuario.getNombre() : "Enfermero / Veterinario" %></strong><br><span class="opacity-75"><%= usuario != null ? usuario.getRol() : "Enfermero / Veterinario" %></span></span>
        </a>
        <nav class="navx">
